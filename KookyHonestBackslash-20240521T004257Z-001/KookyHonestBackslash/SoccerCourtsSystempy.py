...
class SoccerCourtsSystem:
    ...
    def add_invoice(self):
        ...
        date = input("Enter date of invoice (YYYY-MM-DD): ")
    ...
    def manage_clients(self):
        ...
        self.clients_listbox = Listbox(self.root, width=50, height=10)
        self.clients_listbox.pack()

        for client in self.clients_manager.get_clients():
            self.clients_listbox.insert("end", f"Name: {client['name']}, Email: {client['email']}, Phone: {client['phone']}")
